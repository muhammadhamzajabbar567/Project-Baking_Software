...
namespace Computer
{
    public partial class Form1 : Form
    {
        ...
        private void radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cmb_items.Items.Add("HP Laptop XE 15z");
            cmb_items.Items.Add("HP Laptop  17z");
            cmb_items.Items.Add("HP Pavilion 15t");
        ...
        {
            if (cmb_items.SelectedItem.ToString() == "HP Laptop XE 15z")
            { txt_price.Text = "599"; }
            else if (cmb_items.SelectedItem.ToString() == "HP Laptop  17z")
            { txt_price.Text = "999"; }
            else if (cmb_items.SelectedItem.ToString() == "HP Pavilion 15t")
            { txt_price.Text = "1599"; }
